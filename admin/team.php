<?php
    ...
    if(isset($_COOKIE['team_page'])) {
        $page = $_COOKIE['team_page'];
        setcookie("team_page", '', time() - 3600);
    } else {
        //預設第1頁
        $page = 1;
    }

    if(isset($_COOKIE['team_number'])) {
        $number = $_COOKIE['team_number'];
        setcookie("team_number", '', time() - 3600);
    } else {
        //預設10筆
        $number = 10;
    }
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="listTable">
            <div class="listHead">合作夥伴-中文</div>
            <div class="listBodyWrap">
                <div class="addWrap">
                    <a href="team_add.php" class="addBtn">新增內容</a>
                ...
                <div class="productTable">
                    ...
                    <!-- <div class="main flex">
                        ...
                        <div class="editRow">
                            <a href="team_modify.php" class="edit"><i class="fas fa-edit"></i>編輯</a>
                ...
                success:function(data) {
                    ...
                    if(data.status){
                        ...
                        for (const [key, val] of Object.entries(data.data)) {
                            ...
                            html +=         `<a href="team_modify.php?id=${val.id}&page=${page}&number=${number}" class="edit"><i class="fas fa-edit"></i>編輯</a>`;
