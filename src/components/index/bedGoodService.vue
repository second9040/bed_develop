...
export default {
  ...
  data() {
    return {
      service_desc_obj: [
        {
          name: "門市試躺",
          desc: `免預約！歡迎前往門市試躺體驗，由專人一對一為您解說。<br><br>．忠明店．<br>營業時間：10:00~21:30<br>門市專線：<a href="tel:+886-4-23201861">04-2320-1861</a><br>地址：台中市北區忠明路234號 https://maps.app.goo.gl/SdT2S3j7pAErf8UB7 <br><br>．東山店．<br>營業時間：11:00~20:30<br>門市專線：<a href="tel:+886-4-22431666">04-2243-1666</a><br>台中市北屯區東山路一段35-2號 https://maps.app.goo.gl/eMc5oGj1j8YXHZTs6`,
        },
        {
          name: "專人線上諮詢",
          desc:
            "有任何疑問和需求，都可以透過電話或是LINE@與我們專業的服務人員諮詢聊聊。<br><br>Facebook Messager：m.me/287358568107452<br>LINE@：@121povpz",
        },
        {
          name: "運送舊床回收",
          desc:
            "製床所提供<br>✔免費協助舊床下樓<br>✔舊床回收聯絡<br>✔新床配送服務<br><br>免去處理舊床的煩惱！是時候換張新床好好享受了！",
        },
        {
          name: "10年保固",
          desc:
            "✔床皆是職人手作<br> ✔訂購後7個工作天內交貨<br> ✔10年保固<br> ✔15年責任承擔<br><br> 每張床墊都是專屬於你、為你打造，品質有保證！",
        },
      ],
    };
  },
  methods: {
    ...
    embedLink(text) {
      const addressUrlPattern = /([^<br>]+?)\s+(https?:\/\/maps\.app\.goo\.gl\/[^\s<]+)/gi;
