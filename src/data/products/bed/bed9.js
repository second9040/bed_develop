...
deliverService: {
  img: [
    ...
    img: [
      ...
      'hZuaxaS5uII',
      'n8NJe8928b8',
      '/assets/images/product/bed/9/1.jpg',
      '/assets/images/product/bed/9/2.png',
      '/assets/images/product/bed/9/3.jpg',
  ],
  swiperDelay: 16000,
  desc: `
<p> <span class="font-bold">🔹高支撐 × 高穩定 × 高耐用</span><br>
紮實結構，穩定支撐背脊，釋放壓力。<br>
<span class="font-bold">🔹高碳鋼 Bonnell 彈簧 × SGS 認證</span><br>
高碳鋼彈簧耐壓不變形，通過萬次翻身壓測。<br>
<span class="font-bold">🔹高強度串聯式設計™</span><br>
(S-Grid 串聯專利)改革創新提高彈簧密度，達到低干擾特性<br>
<span class="font-bold">🔹95 % 高純度乳膠 X 天然抗菌</span><br>
採用2英吋(5.08cm)乳膠層，更包覆且服貼<br>
<span class="font-bold">🔹雙層抗干擾張力棉襯</span><br>
雙倍厚度吸壓棉，減少翻身震動並延長床墊壽命。<br>
<span class="font-bold">🔹天絲棉表布層</span><br>
柔軟親膚、不悶不熱，四季舒眠，敏感肌首選<br>
<span class="font-bold">🔹360° M字型床緣加固</span><br>
床緣強化設計，坐臥穩固防滑落，安全感滿分。<br>

</p>

`,
    size_obj: [
      { size: '單人3*6.2尺(91*188cm)', ori_price: 14800, discount_price: 12800 },
      { size: '單人加大3.5*6.2尺(106*188cm)', ori_price: 14980, discount_price: 12980 },
      { size: '標準雙人5*6.2尺(152*188cm)', ori_price: 20800, discount_price: 18800 },
      { size: '雙人加大6*6.2尺(182*188cm)', ori_price: 22800, discount_price: 20800 },
      { size: 'King size6*7尺(182*212cm)', ori_price: 26800, discount_price: 24800 },
    ],
    hardness_degree: 4,
    image_intro: [
      '/assets/images/product/bed/9/structure.jpg',
      '/assets/images/product/bed/9/feature.jpg',
      '/assets/images/product/bed/9/size.jpg'
    ],
    tab_content: [
      {
        name: 'structure',
