...
deliverService: {
  img: [
    ...
    img: [
      '9_RZ4gPHViI',
      '/assets/images/product/bed/10/1.jpg',
      '/assets/images/product/bed/10/2.jpg',
      '/assets/images/product/bed/10/3.jpg',
  ],
  swiperDelay: 16000,
  desc: `
...
`,
    ...
    hardness_degree: 4,
    image_intro: [
      '/assets/images/product/bed/10/structure.jpg',
      '/assets/images/product/bed/10/feature.jpg',
      '/assets/images/product/bed/10/size.jpg'
    ],
    tab_content: [
      {
        name: 'structure',
