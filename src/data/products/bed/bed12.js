...
deliverService: {
  img: [
    ...
    img: [
      '9_RZ4gPHViI',
      '/assets/images/product/bed/12/1.jpg',
      '/assets/images/product/bed/12/2.jpg',
      '/assets/images/product/bed/12/3.jpg',
  ],
  swiperDelay: 16000,
  desc: `
...
`,
    ...
    hardness_degree: 4,
    image_intro: [
      '/assets/images/product/bed/12/structure.jpg',
      '/assets/images/product/bed/12/feature.jpg',
      '/assets/images/product/bed/12/size.jpg'
    ],
    tab_content: [
      {
        name: 'structure',
