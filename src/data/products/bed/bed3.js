export default {
  ...
  deliverService: {
    img: [
      ...
      '/assets/images/product/bed/3/deliver2.png',
      '/assets/images/product/bed/3/deliver3.png',
    ],
...
<p> <span class="font-bold">🔹 Q彈簧 × MIT製造</span><br>採用中鋼材質製成彈簧，彈性Q、不易變形，躺再久都穩如初見。</p>
...
`,
    size_obj: [
      ...
      { size: '單人加大3.5*6.2尺(106*188cm)', ori_price: 11880, discount_price: 9980 },
