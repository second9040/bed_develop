...
deliverService: {
  img: [
    ...
    img: [
      ...
      'hZuaxaS5uII',
      'n8NJe8928b8',
      '/assets/images/product/bed/7/1.jpg',
      '/assets/images/product/bed/7/2.png',
      '/assets/images/product/bed/7/3.png',
  ],
  swiperDelay: 16000,
  desc: `
...
<span class="font-bold">🔹100%純棉表布</span><br>
細緻觸感，柔順透氣<br>
<span class="font-bold">🔹360° M字型床緣加固</span><br>
床緣強化設計，坐臥穩固防滑落，安全感滿分。
...
`,
    size_obj: [
      ...
      { size: '雙人加大6*6.2尺(182*188cm)', ori_price: 15800, discount_price: 13800 },
      { size: 'King size6*7尺(182*212cm)', ori_price: 18800, discount_price: 16800 },
    ],
    hardness_degree: 6,
    image_intro: [
      '/assets/images/product/bed/7/structure.jpg',
      '/assets/images/product/bed/7/feature.jpg',
      '/assets/images/product/bed/7/size.jpg'
    ],
    tab_content: [
      {
        name: 'structure',
