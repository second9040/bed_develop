...
deliverService: {
  img: [
    ...
    img: [
      ...
      'hZuaxaS5uII',
      'n8NJe8928b8',
      '/assets/images/product/bed/8/1.jpg',
      '/assets/images/product/bed/8/2.png',
      '/assets/images/product/bed/8/3.jpg',
  ],
  swiperDelay: 16000,
  desc: `
...
採用1 英吋(2.54cm)乳膠層，更貼合符合人體工學<br>
...
`,
    size_obj: [
      ...
      { size: '標準雙人5*6.2尺(152*188cm)', ori_price: 16800, discount_price: 14800 },
    ...
    hardness_degree: 4,
    image_intro: [
      '/assets/images/product/bed/8/structure.jpg',
      '/assets/images/product/bed/8/feature.jpg',
      '/assets/images/product/bed/8/size.jpg'
    ],
    tab_content: [
      {
        name: 'structure',
