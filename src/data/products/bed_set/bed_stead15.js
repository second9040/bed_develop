export default {
  ...
  deliverService: {
    ...
    img: [
      '/assets/images/product/bed_set/15/1.jpg',
      '/assets/images/product/bed_set/15/2.jpg',
      '/assets/images/product/bed_set/15/3.jpg',
    ],
  desc: `
<p>
<span class="font-bold">🔹 貓抓皮收納床頭箱</span><br>
實用機能 × 耐用質感，一次到位<br><br>
<span class="font-bold">🔹 木心板結構｜穩固耐用</span><br>
選用木心板材質，結構紮實日常使用更安心<br><br>
<span class="font-bold">🔹 斜角貓抓皮靠枕｜好靠又耐磨</span><br>
貼合背部，貓抓皮材質耐刮好清潔，久用也不怕<br><br>
<span class="font-bold">🔹 床頭掀蓋收納｜約30公分大容量</span><br>
掀開即是隱藏收納空間，棉被、枕頭、雜物通通收進去<br><br>
...
`,
    ...
    starting_at: true,
    size_obj: [
      { size: '標準雙人5*6.2尺(152*188cm)', ori_price: 7800, discount_price: 5980 },
      { size: '雙人加大6*6.2尺(182*188cm)', ori_price: 9800, discount_price: 7800 },
      { size: 'kingszie6*7尺(182*212cm)', ori_price: 11800, discount_price: 9800 },
    ],
    image_intro: [
      '/assets/images/product/bed_set/15/intro.jpg',
      '/assets/images/product/bed_set/15/feature.jpg',
      '/assets/images/product/bed_set/15/size.jpg'
    ],
    tab_behavior: 'scroll',
    tab_content: [
      {
