...
高質感真皮皮料，觸感細膩<br>
<span class="font-bold">🔹蓬鬆靠枕床頭，高密度泡棉填充</span><br>
舒適時尚兼具，讓倚靠符合人體工學<br>
<span class="font-bold">🔹實木鋼構結構，穩固耐用</span><br>
實木與鋼構設計，整體扎實穩固，壽命更長。<br>
<span class="font-bold">🔹不鏽鋼腳架(13cm高)</span><br>
腳高設計，掃地機器人清潔0死角<br>
<span class="font-bold">🔹床底LED夜燈設計</span><br>
 智慧型感應式夜燈，柔光不刺眼、不打擾睡眠<br>
...
`,
    ...
    starting_at: true,
    size_obj: [
      { size: '標準雙人5*6.2尺(152*215cm)', ori_price: 16800, discount_price: 14800 },
      { size: '雙人加大6*6.2尺(182*215cm)', ori_price: 20800, discount_price: 18800 },
    ],
    image_intro: [
      '/assets/images/product/bed_set/12/intro.jpg',
      '/assets/images/product/bed_set/12/feature.jpg',
      '/assets/images/product/bed_set/12/size.jpg'
    ],
    tab_behavior: 'scroll',
    tab_content: [
      {
