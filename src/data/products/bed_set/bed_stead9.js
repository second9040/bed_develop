export default {
  ...
  deliverService: {
    ...
    img: [
      '/assets/images/product/bed_set/9/1.jpg',
    ],
  desc: `
<p>
...
`,
    ...
    size_obj: [
      {
        size: '限時聊聊驚喜價', ori_price: 12500, discount_price: 5999 },
    ],
    image_intro: [
      '/assets/images/product/bed_set/9/intro.jpg',
      '/assets/images/product/bed_set/9/feature.jpg',
      '/assets/images/product/bed_set/9/size.jpg'
    ],
    tab_behavior: 'scroll',
    tab_content: [
      {
