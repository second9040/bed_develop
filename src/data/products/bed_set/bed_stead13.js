export default {
  ...
  deliverService: {
    ...
    img: [
      '/assets/images/product/bed_set/13/1.jpg',
      '/assets/images/product/bed_set/13/2.jpg',
      '/assets/images/product/bed_set/13/3.jpg',
    ],
  desc: `
<p>
<span class="font-bold">🔹真皮包覆，柔軟舒適</span><br>
高質感真皮皮料，觸感細膩<br>
<span class="font-bold">🔹極簡弧度床頭，高密度泡棉填充</span><br>
舒適時尚兼具，讓倚靠符合人體工學<br>
...
`,
    ...
    starting_at: true,
    size_obj: [
      { size: '標準雙人5*6.2尺(152*215cm)', ori_price: 18800, discount_price: 16800 },
      { size: '雙人加大6*6.2尺(182*215cm)', ori_price: 20800, discount_price: 18800 },
    ],
    image_intro: [
      '/assets/images/product/bed_set/13/intro.jpg',
      '/assets/images/product/bed_set/13/feature.jpg',
      '/assets/images/product/bed_set/13/size.jpg'
    ],
    tab_behavior: 'scroll',
    tab_content: [
      {
