export default {
  ...
  deliverService: {
    ...
    img: [
      '/assets/images/product/bed_set/8/1.jpg',
      '/assets/images/product/bed_set/8/2.jpg',
    ],
  desc: `
<p>
<span class="font-bold">A款- 國民系列床頭</span><br>
...
<span class="font-bold">B款- 巧多系列床頭</span><br>
🔹簡潔俐落設計，實用性更升級<br>
🔹木心板結構：穩固、耐用度高，不易變形<br>
🔹上方置物空間，擺放小物更整齊<br>
🔹厚度：13~15cm 高度：110cm<br>
🔹另可加購 USB/插座 <br>
🔹多元色系，可依照空間訂製<br>
...
`,
    ...
    size_obj: [
      {
        size: '限時聊聊驚喜價', ori_price: 10500, discount_price: 4999 },
    ],
    image_intro: [
      '/assets/images/product/bed_set/8/intro.jpg',
      '/assets/images/product/bed_set/8/feature.jpg',
      '/assets/images/product/bed_set/8/size.jpg'
    ],
    tab_behavior: 'scroll',
    tab_content: [
      {
