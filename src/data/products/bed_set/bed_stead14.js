export default {
  ...
  deliverService: {
    ...
    img: [
      '/assets/images/product/bed_set/14/1.jpg',
      '/assets/images/product/bed_set/14/2.jpg',
      '/assets/images/product/bed_set/14/3.jpg',
    ],
  desc: `
<p>
...
`,
    ...
    starting_at: true,
    size_obj: [
      { size: '單人加大3.5*6.2尺(106*188cm)', ori_price: 7800, discount_price: 5800 },
      { size: '標準雙人5*6.2尺(152*188cm)', ori_price: 9800, discount_price: 7800 },
      { size: '雙人加大6*6.2尺(182*188cm)', ori_price: 11800, discount_price: 9800 },
      { size: 'kingszie6*7尺(182*212cm)', ori_price: 13800, discount_price: 11800 },
    ],
    image_intro: [
      '/assets/images/product/bed_set/14/intro.jpg',
      '/assets/images/product/bed_set/14/feature.jpg',
      '/assets/images/product/bed_set/14/size.jpg'
    ],
    tab_behavior: 'scroll',
    tab_content: [
      {
