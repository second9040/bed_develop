...
科技泡棉填充，倚靠時更服貼、有支撐<br>
<span class="font-bold">🔹實木鋼構結構，穩固耐用</span><br>
實木與鋼構設計，整體扎實穩固，使用壽命更長。<br>
<span class="font-bold">🔹左右抽屜自由調整</span><br>
收納抽屜可依房間格局更換方向，靈活實用<br>
...
`,
    ...
    starting_at: true,
    size_obj: [
      { size: '標準雙人5*6.2尺(152*215cm)', ori_price: 17800, discount_price: 15800 },
      { size: '雙人加大6*6.2尺(182*215cm)', ori_price: 20800, discount_price: 17800 },
    ],
    image_intro: [
      '/assets/images/product/bed_set/10/intro.jpg',
      '/assets/images/product/bed_set/10/feature.jpg',
      '/assets/images/product/bed_set/10/size.jpg'
    ],
    tab_behavior: 'scroll',
    tab_content: [
      {
