        ...
        <div class="container">
          <div class="row gy-4 align-items-center features-item">
            ...
            >
              <div class="image-stack">
                <img
                  src="../assets/images/features-light-1.jpg"
                  alt=""
                  class="stack-front"
                />
                <img
                  src="../assets/images/features-light-2.jpg"
                  alt=""
                  class="stack-back"
                />
              </div>
          ...
          <div class="row gy-4 align-items-stretch justify-content-between features-item">
            <div
              ...
              data-aos="zoom-out"
            >
              <img src="../assets/images/features-light-3.jpg" class="img-fluid" alt="" />
            </div>
            <div
          ...
          >
            ...
            >
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-1.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-1.jpg"
                    title="App 1"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-2.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-2.jpg"
                    title="Product 1"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-3.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-3.jpg"
                    title="Branding 1"
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-4.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-4.jpg"
                    title="App 2"
                    data-gallery="portfolio-gallery-app"
                    class="glightbox preview-link"
                    ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-5.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-5.jpg"
                    title="Product 2"
                    data-gallery="portfolio-gallery-product"
                    class="glightbox preview-link"
                    ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-6.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-6.jpg"
                    title="Branding 2"
                    data-gallery="portfolio-gallery-branding"
                    class="glightbox preview-link"
                    ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-7.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-7.jpg"
                    title="App 3"
                    data-gallery="portfolio-gallery-app"
                    class="glightbox preview-link"
                    ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-8.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-8.jpg"
                    title="Product 3"
                    data-gallery="portfolio-gallery-product"
                    class="glightbox preview-link"
                    ><i class="bi bi-zoom-in"></i
              ...
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                <img
                  src="../assets/images/masonry-portfolio/masonry-portfolio-9.jpg"
                  class="img-fluid"
                  alt=""
                />
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit</p>
                  <a
                    href="../assets/images/masonry-portfolio/masonry-portfolio-9.jpg"
                    title="Branding 2"
                    data-gallery="portfolio-gallery-branding"
                    class="glightbox preview-link"
                    ><i class="bi bi-zoom-in"></i
            ...
            <div class="col-lg-4">
              <div class="pricing-item">
                ...
                <ul>
                  ...
                  <li>
                    <i class="bi bi-check"></i> <span>Nec feugiat nisl pretium</span>
                  </li>
                  <li>
            ...
            <div class="col-lg-7" data-aos="fade-up" data-aos-delay="200">
              ...
              >
                <swiper-slide
                  ...
                  :key="index"
                >
                  <div class="testimonial-item px-4 py-2">
                    <div class="d-flex">
                      <img
          ...
          <div class="row gy-4">
            ...
            <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <article>
                ...
                <div class="d-flex align-items-center">
                  <img
                    src="../assets/images/blog/blog-author-3.jpg"
                    alt=""
                    class="img-fluid post-author-img flex-shrink-0"
                  />
                  <div class="post-meta">
