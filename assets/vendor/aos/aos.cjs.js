...
var init = function init(settings) {
   ...
   * so CSS can use it
   */
  document.querySelector('.index-page"').setAttribute('data-aos-easing', options.easing);

  document.querySelector('.index-page"').setAttribute('data-aos-duration', options.duration);

  document.querySelector('.index-page"').setAttribute('data-aos-delay', options.delay);
